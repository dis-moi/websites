			...
			?>
				<div class="logo_container">
					...
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<img class="logo-header" src="<?php echo esc_attr( $logo ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
					</a>
				</div>
			<?php
